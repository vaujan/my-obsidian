...
- [ ] Measure query latency at 3k and 30k vectors
- [ ] Decide where embeddings get computed — on-device model, or a batch job on save
- [ ] Work out what sync does: are embeddings replicated, or recomputed per device?
