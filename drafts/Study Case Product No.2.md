...
Tetapi ada gap yang cukup menyita perhatianku sebagai *[product builder](https://vaujan.github.io/)*. Yaitu sistem penyimpanan yang cukup fleksibel untuk berbagai macam format seperti gambar, teks, dan URL. 
...
Setelah Notion kita coret, Evernote dan Obsidian adalah kandidat yang sangat menarik (p.s blog post ditulis di Obsidian). Tapi kedua app tersebut memilliki fungsi utama sebagai pencatat (notetaking). *That's it*. Markdown file, text file -- yang disimpan ke dalam sebuah folder. 
